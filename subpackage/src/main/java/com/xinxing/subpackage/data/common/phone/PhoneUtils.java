package com.xinxing.subpackage.data.common.phone;
...
public class PhoneUtils {
	...
	public static OrderInfo createSendOrderInfo(String orderId,
			String supplierCode, String supplierOrderId, String phone) {
		OrderInfo sendOrderInfo = new OrderInfo();
		sendOrderInfo.setOrderId(orderId);
		sendOrderInfo.setProductInfo(supplierCode);
