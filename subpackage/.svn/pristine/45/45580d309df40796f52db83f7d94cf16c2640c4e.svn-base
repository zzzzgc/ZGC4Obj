package com.xinxing.subpackage.data.common.http;
...
public class HttpUtils {
	 ...
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPostAndEn(String url, String param, Map<String, String> map,String en) {
		PrintWriter out = null;
		BufferedReader in = null;
		String result = "";
		try {
			...
			out.flush();
			// 定义BufferedReader输入流来读取URL的响应
			in = new BufferedReader(new InputStreamReader(conn.getInputStream(),en));
			String line;
			while ((line = in.readLine()) != null) {
				result += line;
			}
	...
	public static String sendPostMap(String url, String param, Map<String, Object> headMap) {
		return sendPostTemplate(url, param, headMap, "UTF-8", 50000);
	}
	
	public static String sendPostMap1(String url, String cQresponserParam, HashMap<String, Object> cQresponserHead,String returnEncode) {
		return sendPostTemplate(url, cQresponserParam, cQresponserHead, returnEncode, 50000);
	}
	 ...
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPostTemplate(String url, String param, Map<String, Object> headMap, String returnEncode, Integer timeOut) {
	...
	/**
	 * 获得对应的xx=yy&&aa==bb 字符串   ASCII字典排序
	 * @param responseMap
	 * @return
	 */
	public static String getStrByMapOrderByABC(Map<String, Object> responseMap) {
		String sign = "";
		Object[] key_arr = responseMap.keySet().toArray();
		Arrays.sort(key_arr);
		for (Object k : key_arr) {
			Object value = responseMap.get(k.toString());
			sign += "&" + k + "=" + value;
		}
		if (sign.length() > 0) {
