	   ...
	   */
	   public  static String decrypt(String content, String sKey) throws Exception {
		...
		public void testName() throws Exception {
			/*String id = "Roj5rgbtT9";
			String key = "CSLHEWhCvSHajhbm";
			String key2 = "FlckHAgVvFnXqQhs";
			String teString = "{'tjm':'666'}";
			String sign = aes(teString, key);
			sign = URLEncoder.encode(sign);
			System.out.println(sign);
			String jsonStr = "";
			jsonStr = CYUEUtil.decrypt(URLDecoder.decode(URLDecoder.decode(sign)),key2);
			System.out.println(jsonStr);*/
			
			//admin查询时属性名过滤测试
			String filterName = "LIKES_NAME_OR_LOGIN_NAME";
			//String filterName = "EQI_callbackStatus";
			String firstPart = StringUtils.substringBefore(filterName, "_");
			System.out.println("firstPart---------:"+firstPart);
			String matchTypeCode = StringUtils.substring(firstPart, 0, firstPart.length() - 1);
			System.out.println("matchTypeCode-----:"+matchTypeCode);
			String propertyTypeCode = StringUtils.substring(firstPart, firstPart.length() - 1, firstPart.length());
			System.out.println("propertyTypeCode--:"+propertyTypeCode);
			String propertyNameStr = StringUtils.substringAfter(filterName, "_");
			System.out.println("propertyNameStr--:"+propertyNameStr);
			String[] propertyNames = StringUtils.splitByWholeSeparator(propertyNameStr, "_OR_");
			System.out.println("propertyNames----:"+propertyNames[0]+"--"+propertyNames[1]);
		}
