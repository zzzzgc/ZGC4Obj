			...
			dg = $('#dg').datagrid(
					{
						...
						columns : [
							[
									...
									{ field : 'handleStatus', title : '手工处理状态', formatter : function(value, row, index) {
										//获取产品的列表
										var retrunVal = value+"";
										$.each(${applicationScope.sysParam.handleStatusMapJson}, function(key, val) {
											if (key == value) {
												retrunVal = val;
												return;
											}
									...
									{ field : 'productCategory_categoryName', title : '产品名称', formatter : function(value, row, index) {
										//获取产品的列表
