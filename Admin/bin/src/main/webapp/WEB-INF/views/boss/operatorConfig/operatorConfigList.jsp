	...
	<div id="tb" style="padding: 5px; height: auto">
		<div>
			<form id="searchFrom" action="">
				...
				</select> <span class="toolbar-item dialog-tool-separator"></span> 状态：<select
					name="filter_EQI_type">
					<option value="">请选择</option>
				...
				</select> <span class="toolbar-item dialog-tool-separator"></span> 省份： <select
					id="province" name="filter_EQS_province" onchange="chooseCity1()">
					<option value="">请选择</option>
					<c:forEach items="${applicationScope.sysParam.provinceMap}"
						var="provinceMap">
						<option value="${provinceMap.value}">${provinceMap.value}</option>
					</c:forEach>
				</select> <span class="toolbar-item dialog-tool-separator"></span> 城市： <select
					id="city" name="filter_EQS_city">
					<option value="">请选择</option>
				</select> <br />
				<div style="height: 7px;"></div>
				<a href="javascript(0)" class="easyui-linkbutton" plain="true"
					iconCls="icon-search" onclick="cx()">查询</a> <span
					class="toolbar-item dialog-tool-separator"></span> <input
					type="reset" value="重置" /> <span
					class="toolbar-item dialog-tool-separator"></span> &nbsp;<input
					type="button" value="批量开通" onclick="updateStatus(1)" /> <span
					class="toolbar-item dialog-tool-separator"></span> &nbsp;<input
					type="button" value="批量关闭" onclick="updateStatus(0)" /> <span
				...
				</select> &nbsp;<input type="button" value="开通全省"
					onclick="updateStateByProvince(1)" /> <span
					class="toolbar-item dialog-tool-separator"></span> &nbsp;<input
					type="button" value="关闭全省" onclick="updateStateByProvince(0)" />
			</form>
			<div style="height: 7px;"></div>
			...
			<shiro:hasPermission name="boss:operatorConfig:update">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					iconCls="icon-edit" plain="true" data-options="disabled:false"
					onclick="upd()">修改</a>
			</shiro:hasPermission>
