		...
		<div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
			<div id="topbar" class="top-bar">
				<div class="top-bar-left">
					<h1 style="margin-left: 10px; margin-top: 10px;color: #fff">${applicationScope.sysParam.commonMap.projectName}<span
							style="color: #3F4752">优狗后台管理系统</span>
					</h1>
				</div>
				...
				<div id="homePanel" data-options="title: '主页', iconCls: 'icon-hamburg-home'">
					<div class="easyui-layout" data-options="fit: true">
						<div data-options="region: 'north', split: false, border: false" style="height: 33px;">
							首页内容
							<div>为了得到最佳体验，请使用chrome浏览器</div>
						</div>
						<div data-options="region: 'center', border: false" style="overflow: hidden;"></div>
					</div>
				</div>
			</div>
		</div>
...
<table id="dg"></table>
	<div id="dlg"></div>
	<div style="position:absolute;bottom:2px;text-align:center;width:90%;margin:0 70px;">广州华屹科技有限公司    <a style="text-decoration:none;color:#000;" href="http://www.miitbeian.gov.cn" target="_blank">粤ICP备15024869号</a></div>
	<script>
