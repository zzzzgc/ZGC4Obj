		...
		<div style="float:left;width:100%;">
			<div class="login_main">
				...
				<div class="login_main_ln">
					<input type="text" id="username"  required="true"  name="username"  placeholder="登录名"/>
				</div>
				<div class="login_main_pw">
					<input type="password" id="password"  required="true"  name="password"  placeholder="密码"/>
				</div>
				<div class="login_main_pw">
					<input type="text" id="securitycode"  required="true" name="securitycode"  placeholder="动态验证码"/>
				</div>
