...
<body>
<div>
	<form id="mainform" action="${ctx}/boss/providerBalanceRecord/addProvider/audit" method="post">
	<table  class="formTable">
		<tr class="hidden">
			<td>
				<input type="hidden" name="providerId" value="${providerInfo.id}"/>
			</td>
		</tr>
		<tr>
			<td>供应商名称：</td>
			<td>
				<input name="providerName " value="${providerInfo.providerName}"  readonly="readonly" data-options="width: 180"/>
			</td>
		</tr>
		<tr>
			<td>注资类型：</td>
