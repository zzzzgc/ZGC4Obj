	...
	<div id="tb" style="padding:5px;height:auto">
		<div>
			<form id="searchFrom" action="">
				...
				<!-- 		供应商查询 start	 -->
				<input type="text" name="filter_EQI_providerId" value="" class="easyui-validatebox" data-options="width:60,prompt: '供应商id'" />
				<input type="text" name="providerName" class="easyui-validatebox" onblur="getProviderId()"
					data-options="width:150,prompt: '供应商名称'" />
			...
			<shiro:hasPermission name="boss:bossCustomerRoute:add">
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true"
					onclick="add('bossCustomerRoute/create',380,800);">添加</a>
			</shiro:hasPermission>
