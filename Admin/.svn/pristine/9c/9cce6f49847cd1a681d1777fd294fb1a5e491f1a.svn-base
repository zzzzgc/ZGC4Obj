			...
			<form id="searchFrom" action="">
				...
				<br /><div style="height: 7px;"></div>
				 <a href="javascript(0)" class="easyui-linkbutton" plain="true" iconCls="icon-search" onclick="cx()">查询</a>
					...
					<span class="toolbar-item dialog-tool-separator"></span> 
					<a href="javascript(0)" class="easyui-linkbutton" plain="true" iconCls="icon-search" onclick="fh()">复核</a>
					<span class="toolbar-item dialog-tool-separator"></span> 
...
$(function(){   
    ...
    columns:[[    
		...
		{field:'status',title:'审核状态',width:100,
			formatter:function(value,row,index){
         		if(value==0){
         			...
         			return "<span class='red'>待复核</span>";
         		}
          	}	
		},
		...
		{field:'reviewName',title:'复核人',width:100},
		{field:'reviewTime',title:'复核时间',width:100}
    ]],
...
function fh(){
	...
	d=$("#dlg").dialog({   
	    ...
	    width: 600,    
	    height: 600,    
	    href:'${ctx}/boss/providerBalanceRecord/review/'+row.id,
	    maximizable:true,
	    modal:true,
	    buttons:[{
			text:'复核',
