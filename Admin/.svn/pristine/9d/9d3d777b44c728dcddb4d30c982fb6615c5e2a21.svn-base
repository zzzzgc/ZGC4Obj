package xinxing.boss.admin.common.utils.servlet;
...
public class ServletUtils {
	 ...
	 * String encode = userName + ":" + password; return "Basic " +
	 * EncodeUtils.base64Encode(encode.getBytes()); }
	 */
}
