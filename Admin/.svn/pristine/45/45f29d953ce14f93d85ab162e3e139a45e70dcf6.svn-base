...
<body>
	<div>
		<form id="mainform" action="${ctx}/boss/numberSegment/update"
			method="post">
			<table class="formTable">
				<tr>

					<td>省份：</td>
					<td><input name="number" type="hidden"
						value="${numberSegment.number}" /> <select id="provincee"
						name="province" onchange="chooseCity()">
	...
	<script type="text/javascript">
		$(function() {
			...
			//判断省下拉框的默认值
			var status = "${numberSegment.province }";
			...
			var operator="${numberSegment.operator}";
		...
		function checkCity() {
			//判断市的下拉框默认值
			var cityStatus = "${numberSegment.city}";
