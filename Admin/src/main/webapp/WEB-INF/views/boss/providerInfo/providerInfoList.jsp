...
<body style="font-family: '微软雅黑'">
	<div id="tb" style="padding:5px;height:auto">
		<div>
			...
			<form id="searchFrom" action="">
				...
				<input type="text" name="filter_LIKES_supplier" class="easyui-validatebox" data-options="width:150,prompt: '供应商简称'" />
			...
			<shiro:hasPermission name="boss:providerInfo:showPriceAndDis">
	...
	<script type="text/javascript">
			...
			dg = $('#dg').datagrid(
					{
						...
						columns : [
							[
									...
									{ field : 'discount', title : '折扣率',hidden:mark},
									...
									{ field : 'allowLossMoney', title : '允许负利润',
									...
									{ field : 'allowCustomer', title : '只允许的采购商' }
		...
		function add() {
			d = $("#dlg").dialog(
					{ title : '添加配置', width : 380, height : 500, href : '${ctx}/boss/providerInfo/create',
		...
		function upd() {
			...
			if (rowIsNull(row))
				return;
			d = $("#dlg").dialog(
					{ title : '修改用户', width : 380, height : 500, href : '${ctx}/boss/providerInfo/update/' + row.id,
						maximizable : true, modal : true, buttons : [
