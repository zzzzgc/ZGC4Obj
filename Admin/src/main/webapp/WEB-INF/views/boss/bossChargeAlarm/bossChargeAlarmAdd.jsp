	...
	<div>
		<form id="mainform" action="${ctx}/boss/bossChargeAlarm/${action}" method="post">
			<table class="formTable">
				...
				<tr>
					<td>产品名称：</td>
					<td><select name="productId" id="productId" multiple="multiple" size="20" onblur="getNames(this)">
							<option value=""></option>
					</select>
					</td>
					<td><input name="batchs" type="hidden" value="" class="easyui-validatebox" /></td>
				</tr>
				<tr>
					<td>充值中笔数：</td>
					<td><input name="chargeNum" type="text" value="" class="easyui-validatebox" /></td>
				</tr>
				<tr>
					<td>耗时(分)：</td>
					<td><input name="useTime" type="text" value="" class="easyui-validatebox" /></td>
				</tr>
			</table>
		</form>
	</div>
